  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_today: "bg-slate-100 text-black dark:bg-slate-800 dark:text-white",
        day_outside:
        ...
        day_range_middle:
          "aria-selected:bg-disabled aria-selected:text-black dark:aria-selected:bg-slate-800 dark:aria-selected:text-slate-50",
