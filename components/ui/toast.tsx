...
>(({ className, ...props }, ref) => (
  <ToastPrimitives.Viewport
    ref={ref}
    className={cn(
      "fixed top-0 left-1/2 transform -translate-x-1/2 z-99999 flex max-h-screen w-full flex-col-reverse p-4 sm:bottom-auto sm:top-0 sm:flex-col md:max-w-[420px]",
      className
    )}
    {...props}
  />
