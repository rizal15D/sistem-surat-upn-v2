...
const Sidebar = ({ session, sidebarOpen, setSidebarOpen }: SidebarProps) => {
  ...
  return (
    <aside
      ref={sidebar}
      className={`absolute left-0 top-0 z-99 flex h-screen w-72.5 flex-col overflow-y-hidden bg-black duration-300 ease-linear dark:bg-boxdark ${
    ...
    >
      ...
      <div className="flex items-center justify-between gap-2 px-6 py-5.5 lg:py-6.5">
        ...
        <span className="w-full text-center font-bold text-bodydark1 text-2xl">
          UPN
        </span>
                        ...
                        >
                          <ul className="mt-4 mb-5.5 flex flex-col gap-2.5 pl-6">
                            ...
                            {permissions.akses_master.sikoja && (
                              <SidebarLinkGroup
                                activeCondition={
                                  pathname === "/data-master/iku" ||
                                  pathname === "/data-master/strategi" ||
                                  pathname === "/data-master/indikator"
                                }
                              >
                                {(handleClick, open) => {
                                  return (
                                    <React.Fragment>
                                      <Link
                                        href="#"
                                        className={`group relative flex items-center rounded-md px-4 font-medium text-bodydark2 duration-300 ease-in-out hover:text-white ${
                                          (pathname === "/data-master/iku" ||
                                            pathname ===
                                              "/data-master/strategi" ||
                                            pathname ===
            ...
            <ul className="mb-6 flex flex-col gap-1.5">
              ...
              <li>
                <Link
                  href="/surat"
                  className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                    pathname === "/surat" && "bg-graydark dark:bg-meta-4"
                  }`}
                >
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              {user.jabatan.permision.buat_surat && (
                <li>
                  <Link
                    href="/templates"
                    className={`group relative flex items-center gap-2.5 rounded-sm py-2 px-4 font-medium text-bodydark1 duration-300 ease-in-out hover:bg-graydark dark:hover:bg-meta-4 ${
                      pathname === "/templates" && "bg-graydark dark:bg-meta-4"
                    }`}
                  >
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
