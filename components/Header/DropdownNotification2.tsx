...
//   const [notifSocket, setNotifSocket] = useState(false);
...
//   //   console.log("notifikasi socket", notifikasi_socket);

//   //   useEffect(() => {
//   //     if (notifikasi_socket) {
//   //       console.log("coba1 ");
//   //       setNotifBaru(notifikasi_socket);
//   //     }
//   //   }, [notifikasi_socket]);
...
//   console.log("notif0 ", notifikasi_socket);
//   socket.on("message", async (data) => {
//     console.log(`notif1`, notifikasi_socket);
//     await delay(10000); //
...
//     console.log(`notif1b`, notifikasi_socket);
//     //   console.log("ok[epc", );
//     // const jabatan_id = parts.pop();

//     Notification.requestPermission().then((perm) => {
//       if (perm === "granted") {
//         console.log("notif2", notifikasi_socket);
//         if (notifSocket) {
//           console.log("notif3 ", notifikasi_socket);
//           notifikasi_socket.forEach((notif: any) => {
